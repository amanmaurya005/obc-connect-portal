...
// import { useRef } from "react";
// // Import local images here — replace these with your own images in src/assets
...
// // ─── Types ────────────────────────────────────────
// // import img3 from "../assets/gellery11.jpeg";────────────────────────────
...
//   return (
//     <section id="gallery" className="py-20 bg-cream-pattern">
//     <div
...
//       {/* ── PROGRESS BAR ── */}
//       <div className="mt-[22px] flex items-center gap-3.5 w-full max-w-[520px]">
...
//           <div
//             className="h-full bg-gradient-to-r from-[#b5803a] to-[#e0a84e] rounded-sm transition-[width] duration-500 ease-[cubic-bezier(0.4,0,0.2,1)]"
...
export const AdvancedSlider: React.FC<AdvancedSliderProps> = ({
  ...
  return (
    <section id="gallery" className="py-20 bg-cream-pattern" ref={sectionRef}>
